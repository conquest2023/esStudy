      ...
      <div class="col-md-6">
        <div class="card shadow-sm">
          <div class="card-body text-center">
            <h2 class="card-title mb-4">구글 로그인 처리 중...</h2>
            ...
            <div v-if="showUsernameForm">
              ...
              <button @click="submitUsername" class="btn btn-danger w-100">확인</button>
            </div>
...
onMounted(async () => {
  ...
  if (code) {
    try {
      ...
      console.error('구글 Fetch 에러:', error)
    }
  }
})
</script>
