//package es.board.repository.query;
//
...
//        queryList.add(createMatchQuery(keyword, languageField, LANGUAGE_BOOST_VALUE).toQuery());
//        queryList.add(createMatchPhraseQuery(keyword, languageField, PHRASE_BOOST_VALUE).toQuery());
//
